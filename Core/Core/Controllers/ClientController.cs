...
namespace WebApplication1.Controllers
{
    public class ClientController : ApiController
    {
        ...
        public void UpdateRecords(Client client)
        {
            ...
            System.Diagnostics.Debug.WriteLine("DATE :"+client.C_Date);

            string action = "UPDATE CLIENT SET C_Name = '" + client.C_Name + "',C_LName = '" + client.C_LName+"',C_Address = '"+client.C_Address+"',C_Phone = "+client.C_Phone+ ",C_Date =  CAST('"+client.C_Date.ToString("yyyy-MM-dd")+"' AS DATETIME)" + ",C_Penalization = "+client.C_Penalization+",C_Status = '"+client.C_Status + "' WHERE C_ID =" + client.C_ID;
        ...
        public JsonResult<List<Client>> Get(string attribute, string id)
        {
            ...
            while (reader.Read())
            {
                ...
                emp.C_Date = Convert.ToDateTime(reader.GetValue(5).ToString());
                emp.C_Status = reader.GetValue(6).ToString();
